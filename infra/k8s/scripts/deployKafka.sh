...
sed -i "s/___CHANGE_ME_KAFKA_NODEPORT___/${NEW_NODE_PORT}/g" ../helm/kafka/confluent-platform-singlenode.yaml ## Set proper namespace
...
sed -i "s/${NEW_NODE_PORT}/___CHANGE_ME_KAFKA_NODEPORT___/g" ../helm/kafka/confluent-platform-singlenode.yaml ## Revert
