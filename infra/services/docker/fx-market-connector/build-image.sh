...
./gradlew -stacktrace fx-market-connector:clean && \
./gradlew -stacktrace fx-market-connector:bootBuildImage -Pversion=${TAG} -Pregistry=${DOCKER_REGISTRY} -Pprofile=${SPRING_PROFILE}
