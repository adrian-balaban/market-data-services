<<<<<<<< HEAD:qa/acceptance-tests/src/test/java/testvisa/TestsPluginFunctionalTest.java
package test.java.testvisa;
========
package helpers;
>>>>>>>> master:qa/acceptance-tests/src/test/java/helpers/TestsPluginFunctionalTest.java
