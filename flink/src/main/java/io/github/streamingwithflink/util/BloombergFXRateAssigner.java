 ...
 */
public class BloombergFXRateAssigner extends BoundedOutOfOrdernessTimestampExtractor<BloombergFXRateReading> {

    /**
     * Configures the extractor with 5 seconds out-of-order interval.
     */
    public BloombergFXRateAssigner() {
     ...
     */
    @Override
    public long extractTimestamp(BloombergFXRateReading r) {
        return r.timestamp;
    }
}
