              ...
              script {
                 withKubeConfig(caCertificate: '',
                   ...
                   restrictKubeConfigAccess: true, serverUrl: 'https://192.168.192.96:6443') {
                     sh "pushd ./infra/k8s && ./deployWithBashOrArgo.sh -with_bash ${user_parameters.useBash} -build ${user_parameters.build} -test ${user_parameters.test} -n ${k8s_namespace} -tag ${env.tag} -registry ${env.registry} -env test -branch ${env.BRANCH_NAME} && popd"
                 }
              }
            }
        }
