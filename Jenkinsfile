              ...
              script {
                 withKubeConfig(caCertificate: '',
                   ...
                   restrictKubeConfigAccess: true, serverUrl: 'https://192.168.192.96:6443') {
                     sh "cd ./infra/k8s ; ./deployWithBashOrArgo.sh -with_bash ${user_parameters.useBash} -build ${user_parameters.build} -test ${user_parameters.test} -n ${k8s_namespace} -tag ${user_parameters.tag_root}-${env.BRANCH_NAME} -registry ${env.registry} -env test -branch ${env.BRANCH_NAME} ; cd ../.."
                 }
              }
            }
        }
